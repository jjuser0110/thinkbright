  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <!--    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">-->
        <!--      <i class="fa fa-building me-sm-1" style="color:black"></i>-->
        <!--    </div>-->
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{ route('receipt.index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
               <i class="fa-solid fa-receipt" style="color:black"></i>
            </div>
        ...
        <!--    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">-->
        <!--      <i class="fa fa-money me-sm-1" style="color:black"></i>-->
        <!--    </div>-->
        ...
        <!--</li>-->
        <!--<li class="nav-item">-->
        <!--  <a class="nav-link  " href="{{ route('extra_received.index') }}">-->
        <!--    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">-->
        <!--      <i class="fa fa-money me-sm-1" style="color:black"></i>-->
        <!--    </div>-->
        <!--    <span class="nav-link-text ms-1">Extra Received</span>-->
        <!--  </a>-->
        <!--</li>-->
        <li class="nav-item">
        ...
        <!--<li class="nav-item">-->
        <!--  <a class="nav-link  " href="{{ route('food_type.index') }}">-->
        <!--    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">-->
        <!--      <i class="fa fa-cog me-sm-1" style="color:black"></i>-->
        <!--    </div>-->
        <!--    <span class="nav-link-text ms-1">Food Type</span>-->
        <!--  </a>-->
        <!--</li>-->
        <li class="nav-item">
          <a class="nav-link  " href="{{ route('school.index') }}">
            ...
            <span class="nav-link-text ms-1">School Setting</span>
          </a>
        </li>
        <li class="nav-item">
