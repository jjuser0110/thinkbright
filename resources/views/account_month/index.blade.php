...
@section('body')
<h4 class="font-weight-bolder mb-0">Accounts</h4>
<div class="row" style="margin-top:20px">
    <div class="card">
      <div class="card-body p-3">
      <button class="btn btn-sm btn-primary" style="margin-right:10px" onclick="window.location.href='{{ route('account_month.create') }}'"><i class="mdi mdi-plus-circle-outline"></i>Add Account Month</button>  
